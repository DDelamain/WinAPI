...
VOID SetSkinFromDLL(HWND hwnd, CONST CHAR sz_skin[]);//1) Прототип функции (объявление функции - Function deciption)
...
LRESULT WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		AddFontResourceEx("Fonts\\digital-7 (mono italic).ttf", FR_PRIVATE, 0);

		hFont = CreateFont
		(
			g_i_FONT_HEIGHT, g_i_FONT_WIDTH,
			0, 0, 500,			//Escapement,Orientation,weight
			FALSE, FALSE, FALSE,	//Italic, Underline, Crossout
			DEFAULT_CHARSET,
